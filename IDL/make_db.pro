...
; pdistort: fractional distorion at tbdot
...
; lbeam: beam power constant during burt (bool)
...
; icelowsum: icelow average before
...
; lcer: cer data usable for fast rotation (bool)
; nicrf: number of icrf data points with +- 2 ms of peak
; lssnpa: 210RT switches (0), 210RT off (1), 210RT on(2)
...
; te: core Thompson central Te (keV)
; dene: core Thompson central density (10^13)

; ecot, ecop, ectrt, ectrp, pcot, pcop, pctrt, pctrp
; average beam coltage and power for co-tangential
